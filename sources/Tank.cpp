...
bool Tank::collideCheck(GameObject* obj) {
  ...
  A[3].x=x+d1*cos1; A[0].y=y+d1*sin1;
  A[2].x=x+d1*cos1; A[1].y=y-d1*sin1;
  A[1].x=x-d1*cos1; A[2].y=y+d1*sin1;
  A[0].x=x-d1*cos1; A[3].y=y-d1*sin1;

  B[3].x=obj->getX()+d2*cos2; B[0].y=obj->getY()+d2*sin2;
  B[2].x=obj->getX()+d2*cos2; B[1].y=obj->getY()-d2*sin2;
  B[1].x=obj->getX()-d2*cos2; B[2].y=obj->getY()+d2*sin2;
  B[0].x=obj->getX()-d2*cos2; B[3].y=obj->getY()-d2*sin2;
  ...
  || (checkLocPointStraight(Q[0], Q[1], Q[2])!=4  && checkLoc3PointStraight(Q[0], Q[1], R[0], R[1], R[2]) !=-1))
      return true;
  if((checkLocPointStraight(Q[0], Q[2], Q[1])!=-1 && checkLoc3PointStraight(Q[0], Q[2], R[0], R[1], R[2]) != 1)
  || (checkLocPointStraight(Q[0], Q[2], Q[1])!=4  && checkLoc3PointStraight(Q[0], Q[2], R[0], R[1], R[2]) !=-1))
      return true;
