...
sf::IntRect Collision::GetAABB(const sf::Sprite& Object) {
    ...
    auto t = Object.getTextureRect();
    sf::Vector2f size = sf::Vector2f(t.width, t.height);
    ...
    sf::IntRect AABB = sf::IntRect(Left+static_cast<int> (pos.x), Top+static_cast<int> (pos.y), Right, Bottom);
    return AABB;
}
